	...
	if (isRefreshing)
		return (
			<div role="status">
				<svg
					aria-hidden="true"
					className="size-12 mx-auto text-gray-200 animate-spin dark:text-gray-600 fill-blue-600"
					viewBox="0 0 100 101"
					fill="none"
	...
	return (
		<>
			<form onSubmit={handleGen}>
				<label className="mb-3 block">Username (ไม่ต้องใส่ @dpu.ac.th)</label>
